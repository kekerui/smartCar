...
extern int InAngle;
extern double RealDistance;
extern void  SpeedControlTask(void);
extern void  DistanceControlTask(void);
extern void  GetImagTask(void);
extern void  ControlRouter(void);
extern void  SteerDirControl(void);
extern void  Car_Test(void);
extern int32 CarSpeed2LSpeed(int32 CarSpeed,int angle);
