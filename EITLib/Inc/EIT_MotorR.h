...
/*Encode */
#define    MOTORR_ENCODE_FTM             FTM1                                           //右编码器用FTM1
#define    MOTORR_GEAR_N                 9                                              //C车电机自带齿轮齿轮数
#define    ENCODR_GEAR_N                 31                                             //编码器齿数
#define    WHEELR_GEAR_N                 67                                             //左轮减速箱齿轮数 (28*24/10)
#define    ENCODR_CYCLE                  512                                            //编码器线数
#define    WHEELR_LENGTH                 17                                             //后轮周长16.7cm
