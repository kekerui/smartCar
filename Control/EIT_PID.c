...
{
        tPID->fbVal_k6 =tPID->fbVal_k5;
	tPID->fbVal_k5 =tPID->fbVal_k4;
	tPID->fbVal_k4 =tPID->fbVal_k3;
        tPID->fbVal_k3 =tPID->fbVal_k2;
	tPID->fbVal_k2 =tPID->fbVal_k1;
	tPID->fbVal_k1 =tPID->fbVal_k0;
	tPID->fbVal_k0 =fbVal;
        tPID->fbValFilterLast=tPID->fbValFilter;
        tPID->fbValFilter    =(fbVal+tPID->fbVal_k1+tPID->fbVal_k2+tPID->fbVal_k3+tPID->fbVal_k4+tPID->fbVal_k5+tPID->fbVal_k6)/7;
